...
#define EID_RTM_STREAM_PUBLISHED                0x00000021
typedef struct _AGE_PUBSLISHED_PARAM{
	char *url;
	int error;
}AGE_PUBSLISHED_PARAM, *PAGE_PUBSLISHED_PARAM;

#define EID_RTM_STREAM_UNPUBLISHED              0x00000022
